...
def main():
    ...
    if use_cuda:
        print("Using GPU and ResNet architechture model, we froze parameters and replace the classifier with our own (three linear layers with dropout), with lr=0.1 and batch_size=64")
        model.cuda()
    else:
        print("Using CPU")
