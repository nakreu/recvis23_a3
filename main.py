...
def main():
    ...
    if use_cuda:
        print("Using GPU and ResNet architechture model, no frozen parameters, regularization = 0.01 simple classifier (single layer with dropout), with lr=0.1 and batch_size=64")
        model.cuda()
    else:
        print("Using CPU")
